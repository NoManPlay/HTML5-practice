    ...
    (function($) {
        ...
        function setup(__eventMap) {
            ...
            move = function(e) {
                ...
                // console.log(e);
                var deltaY_data = Math.abs(touch.y1 - touch.y2) ;
                if ( deltaY_data < 100)
                {
                    console.log(11)
                    e.preventDefault();
                ...
                console.log("deltaY_data :" + deltaY_data)
        ...
        var eventType = ["swipe", "swipeLeft", "swipeRight", "swipeUp", "swipeDown", "doubleTap", "tap", "singleTap", "longTap"];
        // var eventType = ["swipe", "swipeLeft", "swipeRight", "doubleTap", "tap", "singleTap", "longTap"];
        eventType.forEach(function(eventName,index) {
